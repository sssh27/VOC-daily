...
5. **不要自行更動 UI 配色、字體、圓角等視覺樣式。**
   視覺已進入改版,設計 token 由 SPEC 第 15 節統一定義,**只能照抄,不能自己發揮**。
6. **不要在 App 任何畫面出現「複習」兩個字。** Shawn 說那讓他感覺像在上課。
7. **不要顯示積壓數字、連續天數(streak)、完成率、正確率、任何評比。**
   這是刻意的產品決策,目的是消除罪惡感。

   **例外一:累計字數(「你認識了 N 個字」)要顯示。** 它是成果性質而非評比性質,
   單調遞增、不會歸零。詳見 SPEC 第 12 節。

   **例外二:Library 畫面的牌組進度條與百分比可以顯示。** Shawn 於 v10 裁定。
   理由是那頁不在每日主動線上,不會天天看到,不構成日常壓力來源。
   **這個例外僅限 Library 畫面。** 首頁、學習畫面、學習完成畫面一律不得出現
   任何進度條、百分比、分母、完成率。
...
3. **不要多餘的東西。** 注意這不等於「東西越少越好」。判準是:每個元素都要能說出
   它為什麼在那裡,說不出來就拿掉,說得出來就留著。整個 App 維持兩個主要畫面
   (首頁、學習畫面),不要增加層級。
